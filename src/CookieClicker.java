...
public class CookieClicker {
    ...
    private static final int maxCookies = 5;
    ...
    private static final int miniGameTime = 120;
    ...
    //This algorithm detemines the spawns of the cookies based on the spawn availability in the array.
